...
const CONTRACT_ADDRESSES: Record<Environment, ContractAddresses> = {
  dev: {
    ecoReward: process.env.NEXT_PUBLIC_ECO_REWARD_ADDRESS_DEV || '0x0000000000000000000000000000000000000000',
    ecoVerifier: process.env.NEXT_PUBLIC_ECO_VERIFIER_ADDRESS_DEV || '0x0000000000000000000000000000000000000000',
  },
  staging: {
